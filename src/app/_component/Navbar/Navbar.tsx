  ...
  return (
    <NavigationMenu className="max-w-full p-2 md:px-20 sticky top-0 bg-white z-50 shadow">
      <NavigationMenuList className="flex justify-between">
        <Image src={imgg.src} alt="logo" width={200} height={40} />
        ...
        <div className="flex gap-4">
          <NavigationMenuList className="hidden lg:flex max-w-fit gap-6">
            ...
            <NavigationMenuItem>
              <Link className="hover:text-[#16A34A] transition-all" href="/">
                Home
              </Link>
            </NavigationMenuItem>
            <NavigationMenuItem>
          ...
          <NavigationMenuList className="flex max-w-fit gap-6">
            <NavigationMenuItem>
              <Link
                className=" text-gray-400 text-xl hover:text-[#16A34A] transition-all"
                href="/wishlist"
              >
                <FaRegHeart />
                {numOfWishlistItems !== 0 && (
                  <div className="bg-[#c73f3f] size-5 rounded-full absolute top-[-14px] end-[-12px] flex justify-center items-center text-white text-sm">
                    {numOfWishlistItems}
                  </div>
                )}
              </Link>
            ...
            <NavigationMenuItem>
              <Link
                className="relative text-gray-400 text-2xl hover:text-[#16A34A] transition-all"
                href="/cart"
              >
                <IoCart />
                {numOfCartItems !== 0 && (
                  <div className="bg-[#16A34A] size-6 rounded-full absolute top-[-14px] end-[-12px] flex justify-center items-center text-white text-sm">
                    {numOfCartItems}
                  </div>
                )}
              </Link>
          ...
          <NavigationMenuList className="hidden lg:flex">
            {status === "unauthenticated" ? (
              <NavigationMenuItem>
                <Link href="/login">
                  <Button className="py-5 px-5 rounded-full bg-[#16A34A]">
                    {" "}
                    <FiUser /> Signin
                  </Button>{" "}
                </Link>
              ...
              <span>
                <Button
                  onClick={mySignOut}
                  className="py-5 px-5 rounded-full bg-[#16A34A]"
                >
                  {" "}
                  <FiUser /> log out
                </Button>{" "}
        ...
        <NavigationMenuItem className="flex md:hidden">
          <NavigationMenuTrigger>
            <PiListLight className="text-[#16A34A] text-4xl" />
          </NavigationMenuTrigger>
          <NavigationMenuContent>
